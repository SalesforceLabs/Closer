({
	...
	createComponent: function(compName, attributes, location, append) {
		...
		$A.createComponent(compName, attributes, function(
			newCmp,
			status,
			errorMessage
		) {
	...
	fireApex: function(component, ApexFunctionName, params, attributeName) {
		let helper = this
		let p = new Promise(resolve => {
			helper.fireApexHelper(component, ApexFunctionName, params, resolve, attributeName)
		})
		return p
	},
